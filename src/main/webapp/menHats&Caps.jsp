...
<div class="container">
    <h2 class="section-title">Men's Caps & Hats</h2>
</div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-130.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-130.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title"> Men's Bill Fold Leather Wallet</h5>
                    <div class="price-section">
                        <p class="mb-1">Rs 1,790.00</p>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-131.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-131.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-132.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-132.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-133.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-134.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-135.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-135.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
