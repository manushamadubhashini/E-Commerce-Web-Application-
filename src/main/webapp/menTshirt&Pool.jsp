...
<div class="container">
    <h2 class="section-title">T-shirt & Pool</h2>
</div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-102.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-103.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-104.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-105.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title">T-Shirt White</h5>
                    <div class="price-section">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-106.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-107.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-108.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-109.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title">T-Shirt Grey</h5>
                    <div class="price-section">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-110.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-111.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title"> T-Shirt Navy</h5>
                    <div class="price-section">
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-112.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-113.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title">T-Shirt Maroon</h5>
                    <div class="price-section">
                        <p class="mb-1">Rs 1,690.00</p>
                        <p class="installment-text mb-1">or pay in 3 × Rs 1,750.00</p>
                    </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-114.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-115.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title"> T-Shirt Beige</h5>
                    <div class="price-section">
                        <p class="mb-1">Rs 3,790.00</p>
                        <p class="installment-text mb-1">or pay in 3 × Rs 1,750.00</p>
                    </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 position-relative">
                ...
                <div class="image-container">
                    <img src="images/ec-116.jpg" class="card-img-top primary-image" alt="Rhea Layered Midi Dress">
                    <img src="images/ec-117.jpg" class="card-img-top secondary-image" alt="Rhea Layered Midi Dress">
                    <div class="add-to-cart">
                        <i class="bi bi-cart-plus"></i> Add to cart
                    </div>
                </div>
                <div class="card-body px-0">
                    <h5 class="card-title">T-shirt Green</h5>
                    <div class="price-section">
