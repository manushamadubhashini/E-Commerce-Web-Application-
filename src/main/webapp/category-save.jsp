...
<div class="modal-dialog modal-dialog-centered custom-width">
  <div class="modal-content">
    <div class="modal-body">
      <h3 class="text-center mb-4">Category Save Form</h3>
      <form class="form-horizontal" action="category-save" method="post">
        <div class="row mb-3 align-items-center">
          <label for="category_id" class="col-sm-3 col-form-label label">Category ID :</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="category_id" placeholder="Enter Category ID" name="category_id" required>
          </div>
        </div>
        <div class="row mb-3 align-items-center">
        ...
        <div class="row mb-3 align-items-center">
          ...
          <div class="col-sm-9">
            <textarea class="form-control" rows="5" id="description" placeholder="Enter Category Description" name="description" required></textarea>
          </div>
        </div>
...
<script>
  $('#btn-save').click((e) => {
    ...
    $.ajax({
      url: 'http://localhost:8080/E_CommerceWebApplication_JSP_war_exploded/category-save',
      type: 'POST',
      data: formData,
